...
class OnlinePong(Packet):
    id = PacketIdentifiers.onlinePong
    pingTimestamp = None
    pongTimestamp = None
    
    def decodePayload(self):
        self.pingTimestamp = self.getLong()
        self.pongTimestamp = self.getLong()
        
    def encodePayload(self):
        self.putLong(self.pingTimestamp)
        self.putLong(self.pongTimestamp)
