...
class managers:
    ...
    def register_default_blocks(self) -> None:
        ...
        self.block_manager.register_block(blocks.white_stained_glass_pane())
        self.block_manager.register_block(blocks.magenta_stained_glass_pane())
        self.block_manager.register_block(blocks.light_blue_stained_glass_pane())
        self.block_manager.register_block(blocks.lime_stained_glass_pane())
        self.block_manager.register_block(blocks.pink_stained_glass_pane())
        self.block_manager.register_block(blocks.orange_stained_glass_pane())
        self.block_manager.register_block(blocks.yellow_stained_glass_pane())
        self.block_manager.register_block(blocks.gray_stained_glass_pane())
        self.block_manager.register_block(blocks.light_gray_stained_glass_pane())
        self.block_manager.register_block(blocks.cyan_stained_glass_pane())
        self.block_manager.register_block(blocks.purple_stained_glass_pane())
        self.block_manager.register_block(blocks.blue_stained_glass_pane())
        self.block_manager.register_block(blocks.brown_stained_glass_pane())
