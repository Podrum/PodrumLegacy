...
class managers:
    ...
    def register_default_blocks(self) -> None:
        ...
        self.block_manager.register_block(blocks.still_lava())
        self.block_manager.register_block(blocks.flowing_lava())
        ...
        self.block_manager.register_block(blocks.still_water())
